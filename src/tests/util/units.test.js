...
describe("units", () => {
  describe("#getUnit", () => {
    it("gets unit of greenberry", () => {
      const result = units.getUnit("greenberry");
    ...
    it("gets unit of greenberry using alias", () => {
  ...
  describe("#getDisplay", () => {
    it("gets display of greenberry", () => {
      const result = units.getDisplay("greenberry");
  ...
  describe("#setUnit", () => {
    ...
    it("modifies an existing unit", () => {
      units.setUnit("greenberry", 9);

      const result = units.getUnit("greenberry");

      expect(result).toEqual(9);

      units.setUnit("greenberry", 1);
    });
  });
  describe("#setDisplay", () => {
