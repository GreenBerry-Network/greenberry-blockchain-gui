...
import icon from '../../assets/img/greenberry_circle.svg';
...
const url = 'https://greenberrynetwork.org';
    ...
    <html>
      ...
      <body>
        ...
        <div className="copyright">
          Copyright (c) 2021 Chia Network, Greenberry Network
        </div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
        ...
        <BugReport href="https://github.com/Greenberry-Network/greenberry-blockchain/issues" target="_blank">
          Report an issue
        </BugReport>
        {'{{CSS}}'}
      </body>
