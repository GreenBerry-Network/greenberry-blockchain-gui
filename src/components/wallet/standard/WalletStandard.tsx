...
import { AlertDialog, Flex, Card } from '@greenberry/core';
...
import { mojo_to_greenberry_string, greenberry_to_mojo } from '../../../util/greenberry';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_greenberry_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of greenberry in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Greenberry that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Greenberry that you have just spent but is not
...
function SendCard(props: SendCardProps) {
  ...
  function send() {
    ...
    const amount = greenberry_to_mojo(amount_input.value);
    const fee = greenberry_to_mojo(fee_input.value);
    ...
    if (address.includes('colour')) {
      dispatch(
        openDialog(
          <AlertDialog>
            <Trans>
              Error: Cannot send greenberry to coloured address. Please enter a greenberry
              address.
            </Trans>
          </AlertDialog>,
        ),
    ...
    if (address.slice(0, 12) === 'greenberry_addr://') {
