...
import { AlertDialog } from '@greenberry/core';
import {
  Typography,
  Button,
  Box,
...
import { greenberry_to_mojo } from '../../../util/greenberry';
...
export const CreateRLAdminWallet = () => {
  ...
  function create() {
    ...
    if (
      greenberryper_input.value === '' ||
      Number(greenberryper_input.value) === 0 ||
      !Number(greenberryper_input.value) ||
      isNaN(Number(greenberryper_input.value))
    ) {
      dispatch(
        openDialog(
          <AlertDialog>
    ...
    const greenberryper = greenberry_to_mojo(greenberryper_input.value);
    const greenberryper_value = Number.parseInt(Number(greenberryper));
    ...
    // var fee = greenberry_to_mojo(fee_input.value);
