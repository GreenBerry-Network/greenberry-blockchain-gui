...
import { AlertDialog, Card, Dropzone, Flex } from '@greenberry/core';
...
import { mojo_to_greenberry_string } from '../../../util/greenberry';
...
const CreateAttest = (props) => {
  ...
  function create_attest() {
    ...
    if (address.substring(0, 12) === 'greenberry_addr://') {
