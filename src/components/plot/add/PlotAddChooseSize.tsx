...
import { CardStep, ConfirmDialog, Link, Select, StateColor } from '@greenberry/core';
    ...
    >
      <Typography variant="subtitle1">
        <Trans>
          ...
          <Link target="_blank" href="https://github.com/Greenberry-Network/greenberry-blockchain/wiki/k-sizes">Learn more</Link>
        </Trans>
      </Typography>
