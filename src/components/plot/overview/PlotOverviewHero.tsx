...
import { CardHero, Link } from '@greenberry/core';
import { PlotHero as PlotHeroIcon } from '@greenberry/icons';
      ...
      <Grid xs={12} md={6} lg={4} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {'Plots are allocated space on your hard drive used to farm and earn Greenberry. '}
              <Link target="_blank" href="https://github.com/Greenberry-Network/greenberry-blockchain/wiki/Network-Architecture">Learn more</Link>
            </Trans>
          </Typography>
          <Button
